...
namespace FocusTreeManager.AsyncImageLoader
{
    public static class Loader
    {
        ...
        [AttachedPropertyBrowsableForType(typeof(Image))]
        public static ImageSource GetSource(Image obj)
        {
            return (ImageSource)obj.GetValue(SourceProperty);
        }

        public static void SetSource(Image obj, ImageSource value)
        {
            obj.SetValue(SourceProperty, value);
        }
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.RegisterAttached("Source", typeof(ImageSource), 
                typeof(Loader), new UIPropertyMetadata(string.Empty, OnSourceChanged));

        private static void OnSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            Manager.Instance.LoadImage(e.NewValue as ImageSource, d as Image);
        }
